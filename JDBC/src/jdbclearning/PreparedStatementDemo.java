...
public class PreparedStatementDemo {
    ...
    // Step 1️: Define Database connection details (URL, Username, Password)
    ...
    public static void main(String[] args) throws SQLException {
        ...
        // Step 6️: Set values to placeholders (1-based index)
        // Learning: Each '?' is replaced with the provided data type safely.
        preparedStatement.setInt(1, id);
        preparedStatement.setString(2, name);
        preparedStatement.setInt(3, marks);
        
        // Step 7️: Execute the query (DML command - INSERT)
        ...
        // Step 8️: (Optional) Fetch and display inserted data for confirmation
